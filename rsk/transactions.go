...
// CalculateTxRoot calculates the RSK transaction trie root using gorsk's Unitrie implementation.
...
// RSK transactions have specific RLP encoding rules for internal transactions (REMASC)
// vs external signed transactions.
